...
class GroqProvider(LLMProvider):
    ...
    def __init__(
        ...
        self._logger = logging.getLogger(f"{__name__}.groq")
    ...
    async def generate(
        ...
        if last_exc:
            raise ProviderServerError(
                f"Groq request failed after {_MAX_RETRIES + 1} attempts."
            ) from last_exc
        ...
        try:
            ...
            raise ProviderMalformedResponse(
                "Groq returned an unexpected payload."
            ) from exc
